...
public class RemoteService extends Service {
    private static final String TAG = "❤️RemoteService";
    ...
    private final IRemoteService.Stub mBinder = new IRemoteService.Stub() {
        public void registerCallback(IRemoteServiceCallback cb) {
            ...
            LogUtils.d(TAG, "registerCallback() called with: " + "cb = [" + cb + "]");
        }

        public void unregisterCallback(IRemoteServiceCallback cb) {
            if (cb != null) mCallbacks.unregister(cb);
            LogUtils.d(TAG, "unregisterCallback() called with: " + "cb = [" + cb + "]");
        }
    };
    /**
    ...
    private final ISecondary.Stub mSecondaryBinder = new ISecondary.Stub() {
        public int getPid() {
            LogUtils.d(TAG, "getPid() called with: " + "");
            return Process.myPid();
        }

        public void basicTypes(int anInt, long aLong, boolean aBoolean,
                               float aFloat, double aDouble, String aString) {
            LogUtils.d(TAG, "basicTypes() called with: " + "anInt = [" + anInt + "], aLong = [" + aLong + "], aBoolean = [" + aBoolean + "], aFloat = [" + aFloat + "], aDouble = [" + aDouble + "], aString = [" + aString + "]");
        }
    };
    int mValue = 0;
    /**
    ...
    public void onCreate() {
        LogUtils.d(TAG, "onCreate() called with: " + "");
    ...
    public void onDestroy() {
        LogUtils.d(TAG, "onDestroy() called with: " + "");
    ...
    public IBinder onBind(Intent intent) {
        ...
        // the Intent.
        LogUtils.d(TAG, "onBind() called with: " + "intent = [" + intent + "]");
    ...
    public static class Binding extends Activity {
        private static final String TAG = "❤️Binding";
        ...
        private ServiceConnection mSecondaryConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                ...
                LogUtils.d(TAG, "onServiceConnected() ISecondary called with: " + "className = [" + className + "], service = [" + service + "]");
            }

            public void onServiceDisconnected(ComponentName className) {
                mSecondaryService = null;
                mKillButton.setEnabled(false);
                LogUtils.d(TAG, "onServiceDisconnected() ISecondary called with: " + "className = [" + className + "]");
            }
        };
            ...
            public void onClick(View v) {
                ...
                if (mSecondaryService != null) {
                    try {
                        ...
                        // other's processes.
                        LogUtils.d(TAG, "onClick() killProcess called with: " + "v = [" + v + "]");
        ...
        private IRemoteServiceCallback mCallback = new IRemoteServiceCallback.Stub() {
            ...
            public void valueChanged(int value) {
                LogUtils.d(TAG, "valueChanged() called with: " + "value = [" + value + "]");
        ...
        private ServiceConnection mRemoteServiceConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                                           IBinder service) {
                LogUtils.d(TAG, "onServiceConnected() RemoteService called with: " + "className = [" + className + "], service = [" + service + "]");
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                LogUtils.d(TAG, "onServiceDisconnected() RemoteService called with: " + "className = [" + className + "]");
                // As part of the sample, tell the user what happened.
        ...
        private OnClickListener mBindListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                // the same interface.
                LogUtils.d(TAG, "onClick() bindService called with: " + "v = [" + v + "]");
                bindService(new Intent(IRemoteService.class.getName()),
                        mRemoteServiceConnection, Context.BIND_AUTO_CREATE);
    ...
    public static class BindingOptions extends Activity {
        ...
        class MyServiceConnection implements ServiceConnection {
            private static final String TAG = "❤️MyServiceConnection";
            ...
            public void onServiceConnected(ComponentName className,
                ...
                LogUtils.d(TAG, "onServiceConnected() called with: " + "className = [" + className + "], service = [" + service + "]");
                mCallbackText.setText("Attached.");
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                LogUtils.d(TAG, "onServiceDisconnected() called with: " + "className = [" + className + "]");
                mCallbackText.setText("Disconnected.");
